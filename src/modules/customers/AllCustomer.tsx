...
const AllCustomer: React.FC = () => {
  ...
  const handleAddCustomerSubmit = async (customerData: Omit<ICustomer, 'id'>) => {
    try {
      await ApiService.post('/customers', customerData);
      message.success('Customer added successfully');
      // Reload customer data here if needed
    } catch (error) {
  ...
  const handleExport = () => {
    alert('Export function executed');
  };
  ...
  return (
    <div>
      <h5 className='page-heading'>All Customers</h5>
